module.exports = (request, response, next) => {
  ...
  response.locals.warnings = request.flash("warnings"); //pega as mensagens de erro guardados no flash "errors" e joga numa variável local que pode ser usada no ejs.
